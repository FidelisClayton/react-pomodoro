...
var _user$project$Model$Flags = F4(
	function (a, b, c, d) {
		return {time: a, timeType: b, title: c, play: d};
	});
...
var _user$project$Views$controlsPlay = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('controlsPlay'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('play btnIcon'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Messages$Play),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'}),
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('stop btnIcon'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Messages$Stop),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
...
var _user$project$Views$displayTypes = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('container display types'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Views$controlsPlay,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Pomodoro$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Model$init, view: _user$project$Views$view, update: _user$project$Update$update, subscriptions: _user$project$Subscriptions$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (play) {
			return A2(
							...
							return A2(
								...
								function (title) {
									return _elm_lang$core$Json_Decode$succeed(
										{play: play, time: time, timeType: timeType, title: title});
								},
								A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string));
						},
						A2(_elm_lang$core$Json_Decode$field, 'timeType', _elm_lang$core$Json_Decode$int));
				},
				A2(_elm_lang$core$Json_Decode$field, 'time', _elm_lang$core$Json_Decode$float));
		},
		A2(_elm_lang$core$Json_Decode$field, 'play', _elm_lang$core$Json_Decode$bool)));
