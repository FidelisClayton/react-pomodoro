...
var _user$project$Model$initialModel = {time: 0, timeType: 0, title: '', play: false};
...
var _user$project$Pomodoro$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Model$initialModel, view: _user$project$Views$view, update: _user$project$Update$update})();

var Elm = {};
Elm['Pomodoro'] = Elm['Pomodoro'] || {};
if (typeof _user$project$Pomodoro$main !== 'undefined') {
    _user$project$Pomodoro$main(Elm['Pomodoro'], 'Pomodoro', undefined);
}
